""" buildbot_extensions CI builders """
...
def ci_builder(workers):
    ...
    # Check out source
    factory.addStep(
        steps.Git(repourl="https://gitlab.com/vengaer/buildbot_extensions.git", mode="incremental")
    )
    ...
    # Lint
    factory.addStep(docker.Docker(command=['pylint', 'buildbot_extensions'], image=TAG, name='Lint'))
